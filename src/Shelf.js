...
class Shelf extends Component {
  ...
  renderContent(pageIndex) {
    switch (pageIndex) {
      ...
      case 1:
        return <div className={styles.Content}><Life/></div>;
      case 2:
        return <div className={styles.Content}><Friend/></div>;
      case 3:
        return <div className={styles.Content}><Mine/></div>;
      default:
        return <div className={styles.Content}><Home/></div>;
    }
    return (
      <div className={styles.Content}>
        <div style={{paddingTop: 60}}>Clicked “{pageIndex}” tab， show “{pageIndex}” information</div>
